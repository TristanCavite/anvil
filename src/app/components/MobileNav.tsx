...
export default function MobileNav({ user, isSeller }: MobileNavProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        style={{ background: 'none', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 8, padding: '7px', cursor: 'pointer', color: '#f1f5f9', alignItems: 'center', justifyContent: 'center' }}
      ...
      <div className={`mobile-menu${open ? ' open' : ''}`} onClick={() => setOpen(false)}>
        <div className="mobile-menu-panel" onClick={e => e.stopPropagation()}>
          ...
          <Link className="mobile-menu-link" href="/" onClick={() => setOpen(false)}>🏠 Home</Link>
