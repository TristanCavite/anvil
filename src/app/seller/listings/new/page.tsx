  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (publish) {
        ...
        if (publishError)
          throw new Error(
            `Published but status update failed: ${publishError.message}`,
          );
      }
            ...
            {photos.length < MAX_PHOTOS && (
              ...
              >
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  PNG, JPG, WEBP — max {MAX_PHOTO_MB} MB each
                </p>
                <input
                  ref={fileRef}
                  type="file"
                  ...
                  className="hidden"
                  onChange={(e) =>
                    e.target.files && handlePhotoFiles(e.target.files)
                  }
                />
              </div>
            )}
          ...
          <section className="bg-white rounded-2xl border border-gray-200 px-6 py-5 flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                The time range buyers can come to collect their order.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
