...
> = {
  authorized: {
    label: "Confirmed — awaiting seller",
    borderColor: "#3b82f6",
    bg: "#eff6ff",
    badgeBg: "#dbeafe",
    badgeColor: "#1d4ed8",
  ...
  pending_authorization: {
    label: "Request sent — waiting for seller",
    borderColor: "#eab308",
    bg: "#fefce8",
    badgeBg: "#fef9c3",
    badgeColor: "#a16207",
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            />
            <h1
              style={{ fontSize: "0.9rem", fontWeight: 700, color: "#f1f5f9" }}
            >
              My Reservations
            </h1>
          </div>
      ...
      <main style={{ maxWidth: 900, margin: "0 auto", padding: "20px 16px" }}>
        {rows.length === 0 ? (
          ...
          >
            ...
            >
              Browse surplus food and reserve something great.
            </p>
            <Link
              href="/listings"
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {rows.map((r) => {
              const listing = Array.isArray(r.listings)
                ? r.listings[0]
                : r.listings;
              const seller = listing
                ? Array.isArray(listing.seller_business)
                    ...
                    >
                      <div style={{ fontSize: "0.75rem", color: "#6b7280" }}>
                        <p>
                          ...
                          Reserved {formatDate(r.created_at)}
                        </p>
