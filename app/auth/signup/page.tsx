    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white">
      ...
      <main className="mx-auto max-w-md px-4 pb-16 pt-8 sm:px-6">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold text-zinc-900">Create account</h1>
          <p className="mt-2 text-zinc-600">Sign up as a buyer to get started</p>
        </div>

        <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
          <form onSubmit={onSubmit} className="space-y-6">
            <div>
              <label htmlFor="full-name" className="block text-sm font-medium text-zinc-900">
                Full name
              </label>
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-zinc-500">Must be at least 6 characters long</p>
            </div>
